...
public class MainPage_ShowLikesOfComments_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            likers=likeRepository.showLikesOfComment(MainPage_ShowComments_Controller.commentID , Main.mainConnection);
