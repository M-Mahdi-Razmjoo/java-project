...
public class MainPage_ShowLikes_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            likers= likeRepository.showLikesOfPost(MainPage_Controller.sender , MainPage_Controller.content , Main.mainConnection);
