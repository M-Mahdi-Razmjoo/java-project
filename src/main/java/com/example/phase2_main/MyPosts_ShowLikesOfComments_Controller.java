...
public class MyPosts_ShowLikesOfComments_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            likers= likeRepository.showLikesOfComment(MyPosts_ShowComments_Controller.commentID , Main.mainConnection);
