...
public class MainPage_ShowLikesOfCommentsOfComments_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            likers= likeRepository.showLikesOfComment(MainPage_ShowCommentsOfComments_Controller.commentID , Main.mainConnection);
