...
public class RemoveMember_Controller implements Initializable {
    @FXML
    ...
    private void handleMouseClicked(MouseEvent event) throws IOException, SQLException {
        ...
        if (node instanceof Text || (node instanceof TreeCell && ((TreeCell) node).getText() != null)) {
            ...
            groupRepository.removeMember(name , MessagingInGroup_Controller.groupID , Main.mainConnection);
